...
const aURL = [
  ...
  // Right Side
  ['add10d', 'BACK', '#', '1', 'R'],
  ['E1341E', 'LIGHTNING', 'https://map.blitzortung.org/#7.5/35.65/-80.174', '1', 'R'],
  [
    'E1341E',
    'RADAR',
  ...
  ['E1341E', 'AVIATION', 'https://aviationweather.gov/gfa/?center=35.003,-83.606&zoom=6', '1', 'R'],
  [
    'E1341E',
    'WINDS',
...
const aIMG = [
  ...
  // ],
  ['REGIONAL RADAR', 'https://s.w-x.co/staticmaps/wu/wu/wxtype1200_cur/usclt/animate.png'],
  [
    'FORECAST',
  ...
  [
    '',
    'https://services.swpc.noaa.gov/experimental/images/aurora_dashboard/tonights_static_viewline_forecast.jpg',
    'https://services.swpc.noaa.gov/experimental/images/aurora_dashboard/tomorrow_nights_static_viewline_forecast.jpg',
